...
//    Boolean LikeCheker = false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainCasesView = inflater.inflate(R.layout.fragment_alerts, container, false);
        ...
        mArticlesList = (RecyclerView) mMainCasesView.findViewById(R.id.alerts_list);
...
//        caseFab = (FloatingActionButton) mMainCasesView.findViewById(R.id.case_item);
        ...
        mArticlesDatabase = FirebaseDatabase.getInstance().getReference().child("flamelink").child("environments").child("production").child("content").child("alerts").child("en-US");
...
//
    ...
    public static class ArticlesViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView author, content, name, title;
