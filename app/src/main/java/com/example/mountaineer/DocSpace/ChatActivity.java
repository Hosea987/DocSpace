...
//                mSpecialty.setText(specialty);
                ...
                if (!image.equals("default")) {
                    ...
                    Picasso.with(ChatActivity.this).load(image).placeholder(R.drawable.photo_female_8).into(mProfileImage);

                    Picasso.with(ChatActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            .placeholder(R.drawable.photo_female_8).into(mProfileImage, new Callback() {
                        @Override
